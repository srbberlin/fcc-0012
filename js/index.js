...
var Header = function (_React$Component) {
  ...
  Header.prototype.switchDir = function switchDir(e) {
    this.props.sort(!this.props.down, null, null);
  };

  Header.prototype.switchKey = function switchKey(e) {
    this.props.sort(null, e.target.value, null);
  };

  Header.prototype.switchWhich = function switchWhich(e) {
...
var Root = function (_React$Component5) {
  ...
  Root.prototype.getData = function getData(which) {
    $.ajax({
  ...
  Root.prototype.doSort = function doSort(down, key, which, data) {
    if (key === 'name') {
  ...
  Root.prototype.sort = function sort(down, key, which) {
  ...
  Root.prototype.over = function over(e) {
    this.setState({ src: e.currentTarget.currentSrc });
  };

  Root.prototype.out = function out(e) {
    this.setState({ src: '' });
  };
